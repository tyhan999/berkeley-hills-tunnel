...
def substep_assignment(nodes_df=None, weighted_edges_df=None, od_ss=None, quarter_demand=None, assigned_demand=None, quarter_counts=4, trip_info=None, agent_time_limit = 0, sample_interval=1, highway_list = [], agents_path = None, hour=None, quarter=None, ss_id=None, alpha_f=0.15, beta_f=4):
...
def write_final_vol(edges_df=None, simulation_outputs=None, quarter=None, hour=None, scen_nm=None):
    edges_df.loc[edges_df['vol_tot']>0, ['uniqueid', 'start_nid', 'end_nid', 'length', 'capacity', 'fft', 'vol_tot', 'geometry']].to_csv(simulation_outputs+'/edge_vol/final_edge_vol_hr{}_qt{}_{}.csv'.format(hour, quarter, scen_nm), index=False)
